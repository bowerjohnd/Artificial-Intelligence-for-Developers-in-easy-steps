...
class SubsumptionBot(FuzzyLogicBot) :
    def __init__(self, position) :
        ...
        self.wanderBehavior = self.modules.newBehavior(WanderBehavior)
        self.feedBehavior = self.modules.newBehavior(FeedBehavior)
        self.fleeBehavior = self.modules.newBehavior(FleeBehavior)
...
class FeedBehavior(Behavior) :
    ...
    def tickFunction(self) :
        ...
        if goodInWorld > Fuzzy(0.001) and self.bot.speed < 500 :
