...
def readNames(firstYear, lastYear, genders='GB', nameSize=99) :
    names = set()

    with open('source/full-list-1974-2023.csv', newline='') as csvfile :
...
def lstmProject() :
    names = readNames(firstYear = 1974, lastYear = 2000, genders='B')
    dataset = Names(names)
